...
def test_candidate_dockerfile_pins_base_and_requires_digest_tool_bundle() -> None:
    ...
    assert (
        ...
        "/project-wheel/video_download_control-0.27.0-py3-none-any.whl "
        "/tmp/video_download_control-0.27.0-py3-none-any.whl"
    ) in dockerfile
    ...
    assert "/tmp/video_download_control-0.27.0-py3-none-any.whl" in project_install
