...
- Upload reconciliation polling: [retained controls and the pending full CI maintenance candidate](iteration-0.28.0-upload-reconciliation-node-retention.md).
