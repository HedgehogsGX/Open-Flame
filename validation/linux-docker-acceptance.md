# Iteration 0.27.0 target Linux/Docker acceptance
...
is retained historical engineering evidence. Iteration 0.27.0 advances this
runner's current application identity to `video-download-control==0.27.0` while
