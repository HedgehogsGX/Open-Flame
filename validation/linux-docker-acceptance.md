# Iteration 0.24.4 target Linux/Docker acceptance
...
is retained historical engineering evidence. Iteration 0.24.4 advances this
runner's current application identity to `video-download-control==0.24.4` while
